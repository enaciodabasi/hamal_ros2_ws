...
#include "hamal_diff_drive_controller/diff_drive_controller.hpp"
...
HamalDiffDriveController::HamalDiffDriveController() : controller_interface::ControllerInterface() {}

const char * HamalDiffDriveController::feedback_type() const
{
  return params_.position_feedback ? HW_IF_POSITION : HW_IF_VELOCITY;
}

controller_interface::CallbackReturn HamalDiffDriveController::on_init()
{
  try
  {
...
InterfaceConfiguration HamalDiffDriveController::command_interface_configuration() const
{
...
InterfaceConfiguration HamalDiffDriveController::state_interface_configuration() const
{
  std::vector<std::string> conf_names;
  for (const auto & joint_name : params_.left_wheel_names)
  {
...
controller_interface::return_type HamalDiffDriveController::update(
...
controller_interface::CallbackReturn HamalDiffDriveController::on_configure(
...
controller_interface::CallbackReturn HamalDiffDriveController::on_activate(
  const rclcpp_lifecycle::State &)
{
...
controller_interface::CallbackReturn HamalDiffDriveController::on_deactivate(
  const rclcpp_lifecycle::State &)
{
...
controller_interface::CallbackReturn HamalDiffDriveController::on_cleanup(
  const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
...
controller_interface::CallbackReturn HamalDiffDriveController::on_error(const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
    return controller_interface::CallbackReturn::ERROR;
...
bool HamalDiffDriveController::reset()
{
...
controller_interface::CallbackReturn HamalDiffDriveController::on_shutdown(
  const rclcpp_lifecycle::State &)
{
  return controller_interface::CallbackReturn::SUCCESS;
}

void HamalDiffDriveController::halt()
{
...
controller_interface::CallbackReturn HamalDiffDriveController::configure_side(
...
CLASS_LOADER_REGISTER_CLASS(
  hamal_diff_drive_controller::HamalDiffDriveController, controller_interface::ControllerInterface)
