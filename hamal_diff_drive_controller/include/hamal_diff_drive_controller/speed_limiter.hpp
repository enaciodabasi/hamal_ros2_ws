...
public:
  ...
  {
    min_velocity_ = limits.minVel;
    max_velocity_ = limits.maxVel;
    min_acceleration_ = limits.minAcc;
    max_acceleration_ = limits.maxAcc;
    min_jerk_ = limits.minJerk;
    max_jerk_ = limits.maxJerk;
  }
